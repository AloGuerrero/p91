...
function car1_up()
{
 ...
 {
   car1_y = car1_y - 10;
   console.log("Cuando se presione la flecha arriba, x=" + car1_x+" I y = " +car1_y);
   uploadBackground();
   uploadcar1();
   uploadcar2();
 }
...
function car1_down()
{
 ...
 {
   car1_y = car1_y + 10;
   console.log("Cuando se presione la flecha abajo, x=" + car1_x+" I y = " +car1_y);
   uploadBackground();
   uploadcar1();
   uploadcar2();
 }
...
function car1_left()
{
 ...
 {
   car1_x = car1_x - 10;
   console.log("Cuando se presione la flecha izquierda, x=" + car1_x+" I y = " +car1_y);
   uploadBackground();
   uploadcar1();
   uploadcar2();
 }
...
function car2_up()
{
 ...
 {
   car2_y = car2_y - 10;
   console.log("Cuando se presione la flecha arriba, x=" + car2_x+" I y = " +car2_y);
   uploadBackground();
   uploadcar1();
   uploadcar2();
 }
...
function car2_down()
{
 ...
 {
   car2_y = car2_y + 10;
   console.log("Cuando se presione la flecha abajo, x=" + car2_x+" I y = " +car2_y);
   uploadBackground();
   uploadcar1();
   uploadcar2();
 }
...
function car2_left()
{
 ...
 {
   car2_x = car2_x - 10;
   console.log("Cuando se presione la flecha izquierda, x=" + car2_x+" I y = " +car2_y);
   uploadBackground();
   uploadcar1();
   uploadcar2();
 }
